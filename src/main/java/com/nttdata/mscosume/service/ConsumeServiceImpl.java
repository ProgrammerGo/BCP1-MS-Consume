...
public class ConsumeServiceImpl implements ConsumeService{
    ...
    @Override
    public Mono<Movements> consumeCredit(String idCredit, Float amount) {
    ...
    public Mono<Credit> checkBalance(Credit credit, Float amount){
        return credit.getBalance() > amount ? Mono.just(credit)
                : Mono.error(() -> new IllegalArgumentException("Not enough balance"));
    }

    public Mono<Credit> consumeCredit(Credit credit, Float amount){
    ...
    public Mono<Movements> saveMovement(String idProduct,
        ...
        return consumeProxy.saveHistory(movement);
    }
}